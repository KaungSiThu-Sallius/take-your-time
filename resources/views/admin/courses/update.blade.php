        ...
        <div class="container">
            <div class="row">
                <div class="offset-md-3 col-md-9 col-12">
                    <form action="{{ route('course.update', $course->id) }}" enctype="multipart/form-data" class="card"
                        method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3 mt-4">
                                ...
                                <div class="col-md-6 date">
                                    ...
                                    <div class="input-with-post-icon datepicker">
                                        <input type="date" id="start_course_date" class="form-control" name="start_date"
                                ...
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="course_duration" name="course_duration" class="form-control"
                                            required value={{ $course->course_duration }}>
                                ...
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="apply_form_link" name="apply_form_link" class="form-control"
                                            required value={{ $course->apply_form_link }}>
                                ...
                                <div class="col-12">
                                    <div class="form-group detail_text">
                                        ...
                                        <textarea class="form-control rounded-0" id="detail" rows="3" name="detail"
                                            required>{{ $course->details }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 funding">
                                    ...
                                    <div class="custom-control custom-radio funding">
                                        <input type="radio" class="custom-control-input" id="free_course" name="type"
                                            value="free_course" {{ $course->type == 'free_course' ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="free_course">Free Course</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" id="paid_course" name="type"
                                            value="paid_course" {{ $course->type == 'paid_course' ? 'checked' : '' }}>
                            ...
                            <div class="row mb-2">
                                <div class="col-12 image">
                                    ...
                                    <img src="{{ asset("upload_images/$course->image") }}" alt="scholarship_image"
