    ...
    <section>
        <div class="preview">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('scholarships/phd') }}"
                        class="previewLink activeLink">PhD</a>
                </li>
            </ul>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="filter_btns_group">
                ...
                <a href="{{ url('/scholarships/phd') }}" class="filter_btn_link"><button type="button"
                        class="btn active filter_btn">PhD</button></a>
                ...
                @foreach ($data as $d)
                    <div class="col-md-6 col-lg-6 col-xl-4" data-aos="zoom-in">
                        <a href="{{ url("/scholarships/detail/$d->slug/$d->scholarship_id") }}">
                            <div class="card">
                                <img class="card-img-top" src="{{ asset("upload_images/$d->image") }}" alt="PhD Image">
