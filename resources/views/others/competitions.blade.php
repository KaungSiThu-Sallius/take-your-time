    ...
    <section>
        <div class="preview">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{'/others'}}" class="previewLink">Others</a></li>
                <li class="breadcrumb-item"><a href="{{url('/others/competitions')}}" class="previewLink activeLink">Competitions</a></li>
            </ul>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="filter_btns_group">
                ...
                <a href="{{url('/others/competitions')}}" class="filter_btn_link"><button type="button"
                        class="btn active filter_btn">Competitions</button></a>
            </div>
        </div>
    </section>
                ...
                @foreach ($data as $d)
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <a href="{{url("/others/detail/".$d->slug."/".$d->id)}}">
                            <div class="card">
                                <img class="card-img-top" src="{{asset("post_images/".$d->image)}}" alt="Other Image">
                                <div class="card-header">Competition</div>
                                <div class="card-body">
                                    <div class="card-text">{{$d->title}} <br> <span
                                            style="font-size: 16px; line-height: 37px; font-weight:bold;">({{$d->place}})</span></div>
                                </div>
                                <div class="card-footer">
                                    <i class="fa fa-hourglass-half pr-2" aria-hidden="true" style="color: #2b2e2d;"></i>{{date('F j, Y', strtotime($d->deadline))}}
                                </div>
                            </div>
                        </a>
                    </div>
