            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-md-7">
                    <div class="info">
                        ...
                        <p> <i class="fas fa-signal"></i>   <span style="font-weight: 600;">Field :</span>  {{$detail->field}}</p>
                        ...
                        <p><i class="fa fa-user"></i>   <span style="font-weight: 600;">Organized by :</span> {{$detail->organized_by}}<br></p>
    ...
    <div class="detail_btns">
        <div class="container">
            <div class="filter_btns_group">
                <a href='{{$detail->official_website}}' class="filter_btn_link"><button type="button" class="btn">Official Website</button></a>
  ...
  @section('script')
      <script>
         ...
         yes_feedback.addEventListener('click', ()=>{
             ...
             axios.get('/conferences/post/like/'+<?php echo $detail->id ?>)
             .then(res=>{
