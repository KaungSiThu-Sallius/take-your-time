                ...
                @foreach ($jobs as $j)
                    <div class="col-md-6 col-lg-6 col-xl-4" data-aos="zoom-in">
                        <a href="{{ url('/jobs/detail/' . $j->slug . '/' . $j->id) }}">
                            <div class="card">
                                <img class="card-img-top" src="{{ asset('upload_images/' . $j->image) }}"
                                    alt="Job Image">
                                ...
                                <div class="card-body">
                                    <div class="card-text">{{ $j->title }}<br> <span
                                            style="font-size: 16px; line-height: 37px; font-weight:bold;">({{ $j->place }})</span>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <i class="fa fa-hourglass-half pr-2" aria-hidden="true"
                                        style="color: #2b2e2d;"></i>{{ date('F j, Y', strtotime($j->deadline)) }}
                                </div>
                            </div>
                        </a>
                    </div>
