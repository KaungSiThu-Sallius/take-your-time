        ...
        <div class="data">
            <div class="row mt-5">
                <div class="offset-md-3 col-12 col-md-9 col-12">
                    <div class="heading">
                        <div class="row">
                            <div class="col-6"><h2>Jobs</h2></div>
                            <div class="col-6">
                                <a href="{{route('job.create')}}"><div class="button btn">Create</div></a>
                    ...
                    <div class="table-responsive data_table">
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody>
                            @foreach ($jobs as $j)
                            <tr>
                                <th scope="row">{{($jobs->currentPage() - 1) * $jobs->perPage() + $loop->iteration}}</th>
                                <th>{{$j->title}}</th>
                                <td>
                                ...
                                <td>
                                    <a href="{{route('job.show',$j->id)}}"><span class="badge badge-pill badge-info">Details</span></a>
                                    <a href="{{route('job.edit',$j->id)}}"><span class="badge badge-pill badge-warning">Update</span></a>
                                    <form action="{{route('job.destroy', $j->id)}}" method="post" style="display:inline;">
                                        @method('delete')
                                        @csrf
