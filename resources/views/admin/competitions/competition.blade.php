        ...
        <div class="container">
            <div class="row mt-4">
                <div class="offset-md-3 col-md-9 col-12">
                    <div class="search">
                        <form action="{{ url('admin/competitionIndex/search') }}" method="GET">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($competitions as $o)
                                            <tr>
                                                <th scope="row">
                                                    {{ ($competitions->currentPage() - 1) * $competitions->perPage() + $loop->iteration }}
                                                </th>
                                                <th>{{ $o->title }}</th>
                                                <td>
                                                    Competition
                                                ...
                                                <td>
                                                    <a href="{{ route('competition.show', $o->id) }}"><span
                                                            class="badge badge-pill badge-info">Details</span></a>
                                                    <a href="{{ route('competition.edit', $o->id) }}"><span
                                                            class="badge badge-pill badge-warning">Update</span></a>
                                                    <form action="{{ route('competition.destroy', $o->id) }}"
