        ...
        <div class="container">
            <div class="row">
                <div class="offset-md-3 col-md-9 col-12">
                    <form action="{{ route('job.update', $job->id) }}" enctype="multipart/form-data"
                        class="card" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="card-header">
                            <h2 class="mb-4">Update Job <span
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="md-form mb-0">
                                            <input type="text" id="organization" name="organization" class="form-control"
                                                required value="{{ $job->organization_name }}">
                                            <label for="organization"
                                                class="">Organization Name</label>
                                    </div>
                                </div>
                                <div class="
                                                col-md-6">
                            ...
                            <div class="
                                ...
                                <div class="
                                                                col-md-6">
                                                                <div class="md-form mb-0">
                                                                    <input type="text" id="apply_form_link"
                                                                        name="apply_form_link" class="form-control"
                                                                        required value="{{ $job->apply_form_link }}">
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-12">
                                                            <div class="form-group detail_text">
                                                                <h5>Details</h5>
                                                                <textarea class="form-control rounded-0" id="detail"
                                                                    rows="3" name="detail"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group other_text">
                                                                ...
                                                                <textarea class="form-control rounded-0"
                                                                    id="other_information" rows="3"
                                                                    name="other_information">{{ $job->other_information }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-12 funding">
                                                            ...
                                                            <div class="custom-control custom-radio funding">
                                                                <input type="radio" class="custom-control-input"
                                                                    id="part_time_job" name="type" value="part_time_job"
                                                                    {{ $job->type == 'part_time_job' ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                                    for="part_time_job">Part-Time Job</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input"
                                                                    id="full_time_job" name="type" value="full_time_job"
                                                                    {{ $job->type == 'full_time_job' ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                                    for="full_time_job">Full-Time Job</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input"
                                                                    id="internship" name="type" value="internship"
                                                                    {{ $job->type == 'internship' ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                    ...
                                                    <div class="row mb-2 application_process">
                                                        ...
                                                        @foreach ($job->document as $d)
                                                            <div class="col-md-6">
                                                                <label for="document{{ $loop->iteration }}">Document
                                                                    {{ $loop->iteration }}</label>
                                                                <textarea class="form-control rounded-0 mb-3"
                                                                    id="{{ $loop->iteration }}" rows="3"
                                                                    name="document[]">{{ $d->document }}</textarea>
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-12 image">
                                                            ...
                                                            <img src="{{ asset("upload_images/$job->image") }}"
                                                                alt="job_image"
