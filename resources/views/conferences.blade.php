...
<section>
    <div class="preview">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('/conferences')}}" class="previewLink activeLink">Conferences</a></li>
        </ul>
    </div>
</section>
        ...
        <div class="row">
            @foreach ($data as $d)
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <a href="#">
                            <div class="card">
                                <img class="card-img-top" src="{{$d->image}}" alt="Conference Image">
                                <div class="card-header">Conference</div>
                                <div class="card-body">
                                    <div class="card-text">{{$d->title}} <br> <span
                                        style="font-size: 14px; line-height: 37px; font-weight:bold;">( {{$d->funding}} || {{$d->place}} )</span></div>
                                </div>
