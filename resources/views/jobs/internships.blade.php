...
@section('title')
<title>Take Your Time - Internships</title>
@endsection
@section('nav_items')
    ...
    <section>
        <div class="preview">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('/jobs/internships')}}" class="previewLink activeLink">Internships</a></li>
            </ul>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="filter_btns_group">
                ...
                <a href="{{url('/jobs/internships')}}" class="filter_btn_link"><button type="button"
                    class="btn active filter_btn">Internships</button></a>
