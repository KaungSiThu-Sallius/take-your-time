...
<div class="container">
            ...
            <div class="table-responsive data_table">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <th scope="row">{{($today_messages->currentPage() - 1) * $today_messages->perPage() + $loop->iteration}}</th>
                        <td>{{$m->name}}</td>
                        <td>
                            {{$m->email}}
                        </td>
    ...
    <div class="row mt-5 mb-5">
        <div class="offset-md-3 col-md-9">
            <div class="heading mb-4">
                <div class="row">
                    <div class="col-6"><h2>All Messages</h2>
                    </div>
            ...
            <div class="table-responsive data_table">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <th scope="row">{{($all_messages->currentPage() - 1) * $all_messages->perPage() + $loop->iteration}}</th>
                        <td>{{$m->name}}</td>
                        <td>
                            {{$m->email}}
                        </td>
                        ...
                        <td>
                            <form action="{{url('admin/messages', $m->id)}}" method="post" style="display:inline;">
                                @method('delete')
                                @csrf
