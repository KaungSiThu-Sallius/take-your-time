                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($today_comments as $c)
                                    <tr>
                                        <th scope="row">
                                            {{ ($today_comments->currentPage() - 1) * $today_comments->perPage() + $loop->iteration }}
                                        </th>
                                        <td>{{ $c->name }}</td>
                                        <td>
                                            {{ $c->post->title }}
                                        ...
                                        <td>
                                            ...
                                            @elseif ($c->post->name == 'grant')
                                                <a href="{{ url("/grants/detail/$slug/$post_id") }}"
                                                    target="_blank"><span class="badge badge-pill badge-info">See
                                                        Post</span></a>
                                            @elseif ($c->post->name == 'competition')
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($all_comments as $c)
                                <tr>
                                    <th scope="row">
                                        {{ ($all_comments->currentPage() - 1) * $all_comments->perPage() + $loop->iteration }}
                                    </th>
                                    <td>{{ $c->name }}</td>
                                    <td>
                                        {{ $c->post->title }}
                                    ...
                                    <td>
                                        ...
                                        @elseif ($c->post->name == 'other')
                                            <a href="{{ url("/others/detail/$slug/$post_id") }}" target="_blank"><span
                                                    class="badge badge-pill badge-info">See Post</span></a>
                                        @endif
                                        <form action="{{ url('admin/comments', $c->id) }}" method="post"
