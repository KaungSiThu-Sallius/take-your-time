...
@section('title')
<title>Take Your Time - Fellowship</title>
@endsection
@section('nav_items')
    ...
    <section>
        <div class="preview">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('scholarships/fellowship')}}" class="previewLink activeLink">Fellowship</a></li>
            </ul>
        </div>
    </section>
    ...
    <section class="filter_nav">
        <div class="container-fluid">
            <div class="filter_btns_group">
                ...
                <a href="{{url('/scholarships/master')}}" class="filter_btn_link"><button type="button" class="btn">Master</button></a>
                <a href="{{url('/scholarships/phd')}}" class="filter_btn_link"><button type="button" class="btn">PhD</button></a>
                <a href="{{url('/scholarships/fellowship')}}" class="filter_btn_link"><button type="button"
                        class="btn active filter_btn">Felllowship</button></a>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <a href="{{url("/scholarships/detail/$d->slug/$d->scholarship_id")}}">
                        <div class="card">
                            <img class="card-img-top" src="{{asset("images_database/$d->image")}}" alt="Fellowship Image">
                            <div class="card-header">Fellowship</div>
                            <div class="card-body">
                                <div class="card-text">{{$d->title}} <br> <span
                                    style="font-size: 14px; line-height: 37px; font-weight:bold;">( {{$d->funding}} || {{$d->country}} )</span></div>
                            </div>
                            <div class="card-footer">
                                <i class="fa fa-hourglass-half pr-2" aria-hidden="true"></i>{{date('F j, Y', strtotime($d->deadline))}}
                            </div>
                        </div>
                    </a>
                </div>
