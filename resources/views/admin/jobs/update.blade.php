        ...
        <div class="container">
            <div class="row">
                <div class="offset-md-3 col-md-9 col-12">
                    <form action="{{ route('job.update', $job->id) }}" enctype="multipart/form-data" class="card"
                        method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="job_duration" name="job_duration" class="form-control"
                                            required value="{{ $job->job_duration }}">
                                ...
                                <div class="col-md-12 funding">
                                    ...
                                    <div class="custom-control custom-radio funding">
                                        <input type="radio" class="custom-control-input" id="part_time_job" name="type"
                                            value="part_time_job" {{ $job->type == 'part_time_job' ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="part_time_job">Part-Time Job</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" id="full_time_job" name="type"
                                            value="full_time_job" {{ $job->type == 'full_time_job' ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="full_time_job">Full-Time Job</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" id="internship" name="type"
                                ...
                                @foreach ($job->document as $d)
                                    <div class="col-md-6">
                                        <label for="document{{ $loop->iteration }}">Document
                                            {{ $loop->iteration }}</label>
                                        <textarea class="form-control rounded-0 mb-3" id="{{ $loop->iteration }}"
                                            rows="3" name="document[]">{{ $d->document }}</textarea>
                            ...
                            <div class="row mb-2">
                                <div class="col-12 image">
                                    ...
                                    <img src="{{ asset("upload_images/$job->image") }}" alt="job_image"
