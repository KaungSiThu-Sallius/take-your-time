                                ...
                                <div class="
                                            ...
                                            <div class="md-form mb-0">
                                                <input type="text" id="country" name="country" class="form-control"
                                                    required value="{{ $scholarship->country }}">
                                                    ...
                                                    <div class="col-md-6 date">
                                                        ...
                                                        <div class="input-with-post-icon datepicker">
                                                            <input type="date" id="deadline" class="form-control"
                                                                name="deadline" value={{ $scholarship->deadline }}>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6 type_checkbox">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="undergraduate" name="type[]" value="Undergraduate"
                                                                @foreach ($types as $t)
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="master"
                                                                name="type[]" value="Master" @foreach ($types as $t)
                                                            {{ $t == 'Master' ? 'checked' : '' }}
                                                            @endforeach>
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="phd"
                                                                name="type[]" value="Phd" @foreach ($types as $t)
                                                            {{ $t == 'Phd' ? 'checked' : '' }}
                                                            @endforeach>
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="fellowship" name="type[]" value="Fellowship"
                                                                @foreach ($types as $t)
                                                            {{ $t == 'Fellowship' ? 'checked' : '' }}
                                                            @endforeach>
                                                            <label class="custom-control-label"
                                                                for="fellowship">Fellowship</label>
                                                        </div>
                                                    </div>
