        ...
        <div class="preview detail_preview">
            ...
            <ul class="breadcrumb">
                ...
                @if ($detail->type == 'free_course')
                    <li class="breadcrumb-item"><a href="{{url('courses/freeCourses')}}" class="previewLink">Free Courses</a></li>
                @elseif ($detail->type == 'paid_course')
                    <li class="breadcrumb-item"><a href="{{url('courses/paidCourses')}}" class="previewLink">Paid Courses</a></li>
                @endif
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-8 col-md-7">
                    <div class="info">
                        <p><i class="far fa-calendar-alt"></i>   <span style="font-weight: 600;">Course Start Date :</span> <span style="color: red">{{date('F j, Y', strtotime($detail->start_date))}}</span></p>
                        ...
                        <p><i class="fas fa-clock"></i>   <span style="font-weight: 600;">Place :</span> {{$detail->course_duration}}</p>
                        <p><i class="fas fa-globe"></i>   <span style="font-weight: 600;">Duration :</span> {{$detail->place}}</p>
                        <p><i class="fa fa-user"></i>   <span style="font-weight: 600;">Taught by :</span> {{$detail->taught_by}}<br></p>
        ...
        <div class="container">
            <div class="filter_btns_group">
                <a href='{{$detail->apply_form_link}}' class="filter_btn_link"><button type="button"
                        class="btn">Course Application</button></a>
            </div>
        </div>
    </div>
