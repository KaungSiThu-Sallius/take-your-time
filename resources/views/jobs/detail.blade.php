        ...
        <div class="preview detail_preview">
            ...
            <ul class="breadcrumb">
                ...
                @if ($detail->type == 'part_time_job')
                    <li class="breadcrumb-item"><a href="{{url('jobs/partTimeJobs')}}"           class="previewLink">Part-Time Jobs</a></li>
                @elseif ($detail->type == 'full_time_job')
                    <li class="breadcrumb-item"><a href="{{url('jobs/fullTimeJobs')}}"           class="previewLink">Full-Time Jobs</a></li>
