...
<div class="container">
            ...
            <div class="table-responsive data_table">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <th scope="row">{{($today_likes->currentPage() - 1) * $today_likes->perPage() + $loop->iteration}}</th>
                        <td>
                            {{$l->post->title}}
                        </td>
                        <td>
    ...
    <div class="row mt-5 mb-5">
        <div class="offset-md-3 col-md-9">
            <div class="heading mb-4">
                <div class="row">
                    <div class="col-6"><h2>Most Like Posts</h2></div>
                    @if ($type == 'total_like')
                    <div class="col-6">
                        <a href="{{url('admin/dashboard')}}"><div style='float:right;' class="button btn">Back</div></a>
                    </div>
            ...
            <div class="table-responsive data_table">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <th scope="row">{{($all_likes->currentPage() - 1) * $all_likes->perPage() + $loop->iteration}}</th>
                        <td>
                            {{$l->post->title}}
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            @elseif ($l->post->name == 'other')
                                <a href="{{url("/others/detail/$slug/$post_id")}}" target="_blank"><span class="badge badge-pill badge-info">See Post</span></a>
                            @endif
                            <form action="{{url('admin/comments', $l->id)}}" method="post" style="display:inline;">
                                @method('delete')
                                @csrf
