            ...
            <div class="row">
                @foreach ($other as $o)
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <a href="#">
                            <div class="card">
                                <img class="card-img-top" src="{{$o->image}}" alt="Other Image">
                                ...
                                <div class="card-body">
                                    <div class="card-text">{{$o->title}} <br> <span
                                            style="font-size: 16px; line-height: 37px; font-weight:bold;">({{$o->place}})</span></div>
                                </div>
                                <div class="card-footer">
                                    <i class="fa fa-hourglass-half pr-2" aria-hidden="true" style="color: #2b2e2d;"></i>{{date('F j, Y', strtotime($o->deadline))}}
                                </div>
                            </div>
                        </a>
                    </div>
