...
@section('contents')
    ...
    <section>
        <div class="preview">
            <h2 class="previewText">Grants</h2>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/')}}" class="previewLink">Home</a></li>
                <li class="breadcrumb-item"><a href="{{url('/grants')}}" class="previewLink activeLink">Grants</a></li>
            </ul>
        </div>
    </section>
            ...
            <div class="row">
                @foreach ($data as $d)
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <a href="#">
                            <div class="card">
                                <img class="card-img-top" src="{{$d->image}}" alt="Grants Image">
