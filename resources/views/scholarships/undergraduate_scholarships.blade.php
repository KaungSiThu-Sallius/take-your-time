...
@section('title')
<title>Take Your Time - Undergraduate</title>
@endsection
@section('nav_items')
    ...
    <section>
        <div class="preview">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('scholarships/undergraduate')}}" class="previewLink activeLink">Undergraudate</a></li>
            </ul>
        </div>
    </section>
                ...
                @foreach ($data as $d)
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <a href="{{url("/scholarships/detail/$d->slug/$d->scholarship_id")}}">
                            <div class="card">
                                <img class="card-img-top" src="{{asset("images_database/$d->image")}}" alt="Undergraduate Image">
