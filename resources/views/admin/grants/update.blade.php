        ...
        <div class="container">
            <div class="row">
                <div class="offset-md-3 col-md-9 col-12">
                    <form action="{{ route('grant.update', $grant->id) }}" enctype="multipart/form-data" class="card"
                        method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6 date">
                                    ...
                                    <div class="input-with-post-icon datepicker">
                                        <input type="date" id="start_application_date" class="form-control"
                                            name="start_application_date" value={{ $grant->start_application_date }}>
                                ...
                                <div class="col-12">
                                    <div class="form-group detail_text">
                                        ...
                                        <textarea class="form-control rounded-0" id="detail" rows="3" name="detail"
                                            required>{{ $grant->details }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 type_checkbox">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="undergraduate"
                                            name="level[]" value="Undergraduate" @foreach ($level as $t)
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="master" name="level[]"
                                            value="Master" @foreach ($level as $t)
                                        {{ $t == 'Master' ? 'checked' : '' }}
                                        @endforeach>
                                        <label class="custom-control-label" for="master">Master</label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="phd" name="level[]"
                                            value="Phd" @foreach ($level as $t)
                                        {{ $t == 'Phd' ? 'checked' : '' }}
                                        @endforeach>
                                ...
                                <div class="col-md-6 funding">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" id="self_funded" name="funding"
                                            value="Self-Funded" {{ $grant->funding == 'Self-Funded' ? 'checked' : '' }}>
                            ...
                            <div class="row mb-2">
                                <div class="col-12 image">
                                    ...
                                    <img src="{{ asset("upload_images/$grant->image") }}" alt="scholarship_image"
