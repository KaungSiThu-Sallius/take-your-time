...
@section('nav_items')
    ...
    <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu dropdown-primary active" aria-labelledby="navbarDropdownMenuLink">
    ...
    <section>
        <div class="preview">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/jobs/partTimeJobs') }}"
                        class="previewLink activeLink">Part-Time</a></li>
            </ul>
        </div>
    </section>
