        ...
        <div class="container">
            <div class="row">
                <div class="offset-md-3 col-md-9 col-12">
                    <form action="{{ route('grant.update', $grant->id) }}" enctype="multipart/form-data"
                        class="card" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="card-header">
                            <h2 class="mb-4">Update Grant <span
                                    ...
                                    <div class="col-md-12">
                                        <div class="md-form mb-0">
                                            <input type="text" id="given_by" name="given_by" class="form-control" required
                                                value="{{ $grant->given_by }}">
                                            <label for="given_by"
                                                class="">Given By</label>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="md-form mb-0">
                                                        <input type="text" id="source" name="source" class="form-control"
                                                            required value="{{ $grant->official_website }}">
                                                        <label for="source"
                                ...
                                <div class="
                                                ...
                                                <div class="row mb-3 mt-4">
                                                    <div class="col-md-6 date">
                                                        ...
                                                        <div class="input-with-post-icon datepicker">
                                                            <input type="date" id="start_application_date"
                                                                class="form-control" name="start_application_date"
                                                                value={{ $grant->start_application_date }}>
                                                    ...
                                                    <div class="col-md-6 date">
                                                        ...
                                                        <div class="input-with-post-icon datepicker">
                                                            <input type="date" id="deadline" class="form-control"
                                                                name="deadline" value={{ $grant->deadline }}>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-12">
                                                        <div class="form-group detail_text">
                                                            <h5>Details</h5>
                                                            <textarea class="form-control rounded-0" id="detail" rows="3"
                                                                name="detail" required>{{ $grant->details }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-12">
                                                        <div class="form-group other_text">
                                                            ...
                                                            <textarea class="form-control rounded-0" id="other_information"
                                                                rows="3"
                                                                name="other_information">{{ $grant->other_information }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6 type_checkbox">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="undergraduate" name="level[]" value="Undergraduate"
                                                                @foreach ($level as $t)
                                                            {{ $t == 'Undergraduate' ? 'checked' : '' }}
                                                            @endforeach
                                                            >
                                                            <label class="custom-control-label"
                                                                for="undergraduate">Undergraduate</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="master"
                                                                name="level[]" value="Master" @foreach ($level as $t)
                                                            {{ $t == 'Master' ? 'checked' : '' }}
                                                            @endforeach>
                                                            <label class="custom-control-label" for="master">Master</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="phd"
                                                                name="level[]" value="Phd" @foreach ($level as $t)
                                                            {{ $t == 'Phd' ? 'checked' : '' }}
                                                            @endforeach>
                                                    ...
                                                    <div class="col-md-6 funding">
                                                        ...
                                                        <div class="custom-control custom-radio funding">
                                                            <input type="radio" class="custom-control-input"
                                                                id="fully_funded" name="funding" value="Fully-Funded"
                                                                {{ $grant->funding == 'Fully-Funded' ? 'checked' : '' }}>
                                                            <label class="custom-control-label"
                                                                for="fully_funded">Fully-Funded</label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                id="partial_funded" name="funding" value="Partial-Funded"
                                                                {{ $grant->funding == 'Partial-Funded' ? 'checked' : '' }}>
                                                            <label class="custom-control-label"
                                                                for="partial_funded">Partial-Funded</label>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input"
                                                                id="self_funded" name="funding" value="Self-Funded"
                                                                {{ $grant->funding == 'Self-Funded' ? 'checked' : '' }}>
                                                            <label class="custom-control-label"
                                                                for="self_funded">Self-Funded</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4 criteria">
                                                    ...
                                                    @foreach ($grant->criteria as $c)
                                                        <div class="col-md-6">
                                                            ...
                                                            <textarea class="form-control rounded-0 mb-3"
                                                                ...
                                                                name="criteria[]">{{ $c->criteria }}</textarea>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <textarea class="form-control rounded-0 mb-3" rows="3"
                                                ...
                                                <div class="row mb-2 benefit">
                                                    ...
                                                    @foreach ($grant->benefit as $b)
                                                        <div class="col-md-6">
                                                            ...
                                                            <textarea class="form-control rounded-0 mb-3"
                                                                id="{{ $loop->iteration }}" rows="3"
                                                                name="benefit[]">{{ $b->benefit }}</textarea>
                                                ...
                                                <div class="row mb-2 application_process">
                                                    ...
                                                    @foreach ($grant->process as $p)
                                                        <div class="col-md-6">
                                                            ...
                                                            <textarea class="form-control rounded-0 mb-3"
                                                                id="{{ $loop->iteration }}" rows="3"
                                                                name="process[]">{{ $p->process }}</textarea>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-12 image">
                                                        ...
                                                        <img src="{{ asset("upload_images/$grant->image") }}"
