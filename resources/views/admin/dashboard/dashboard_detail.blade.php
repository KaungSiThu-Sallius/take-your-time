                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($d->name == 'scholarship')
                                            ...
                                            <form action="{{ route('scholarship.destroy', $d->post_id) }}" method="post"
                                        ...
                                        @elseif ($d->name == 'conference')
                                            ...
                                            <a href="{{ route('conference.edit', $d->post_id) }}"><span
                                                    class="badge badge-pill badge-warning">Update</span></a>
                                            <form action="{{ route('conference.destroy', $d->post_id) }}" method="post"
                                                style="display:inline;">
                                                @method('delete')
                                                @csrf
                                                <button type="submit" class="badge badge-pill badge-danger"
                                        ...
                                        @elseif ($d->name == 'job')
                                            ...
                                            <a href="{{ route('job.edit', $d->post_id) }}"><span
                                                    class="badge badge-pill badge-warning">Update</span></a>
                                            <form action="{{ route('job.destroy', $d->post_id) }}" method="post"
                                                style="display:inline;">
                                                @method('delete')
                                                @csrf
                                                <button type="submit" class="badge badge-pill badge-danger"
                                        ...
                                        @elseif ($d->name == 'other')
                                            ...
                                            <a href="{{ route('other.edit', $d->post_id) }}"><span
                                                    class="badge badge-pill badge-warning">Update</span></a>
                                            <form action="{{ route('other.destroy', $d->post_id) }}" method="post"
                                                style="display:inline;">
                                                @method('delete')
                                                @csrf
                                                <button type="submit" class="badge badge-pill badge-danger"
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($course as $c)
                                <tr>
                                    <th scope="row">
                                        {{ ($course->currentPage() - 1) * $course->perPage() + $loop->iteration }}</th>
                                    <th>{{ $c->course_name }}</th>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('course.show', $c->id) }}"><span
                                                class="badge badge-pill badge-info">Details</span></a>
                                        <a href="{{ route('course.edit', $c->id) }}"><span
                                                class="badge badge-pill badge-warning">Update</span></a>
