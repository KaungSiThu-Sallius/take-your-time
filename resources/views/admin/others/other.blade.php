                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($others as $o)
                                        <tr>
                                            <th scope="row">
                                                {{ ($others->currentPage() - 1) * $others->perPage() + $loop->iteration }}
                                            </th>
                                            <th>{{ $o->title }}</th>
                                            <td>
                                                @if ($o->type == 'seminar')
                                            ...
                                            <td>
                                                <a href="{{ route('other.show', $o->id) }}"><span
                                                        class="badge badge-pill badge-info">Details</span></a>
                                                <a href="{{ route('other.edit', $o->id) }}"><span
                                                        class="badge badge-pill badge-warning">Update</span></a>
                                                <form action="{{ route('other.destroy', $o->id) }}" method="post"
