    ...
    <section>
        <div class="preview detail_preview">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/competitions') }}" class="previewLink">Competitions</a>
                </li>
...
@section('script')
    <script>
        ...
        yes_feedback.addEventListener('click', () => {
            ...
            axios.get('/competitions/post/like/' + <?php echo $detail->id; ?>)
                .then(res => {
        ...
        create_comment.addEventListener('click', () => {
            if (name.value != "" && comment.value != "") {
                ...
                axios.post('/competitions/post/comment', formData)
                    .then(function(res) {
