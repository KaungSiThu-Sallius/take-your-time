    ...
    <section>
        <div class="preview">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('/scholarships')}}" class="previewLink activeLink">Scholarships</a></li>
            </ul>
        </div>
    </section>
                ...
                @foreach ($scholarships as $d)
                    <div class="col-md-6 col-lg-6 col-xl-4">
                        <a href="{{url("/scholarships/detail/$d->slug/$d->id")}}">
                            <div class="card">
                                <img class="card-img-top" src="{{asset("post_images/$d->image")}}" alt="Scholarship Image">
