        ...
        <div class="preview detail_preview">
            ...
            <ul class="breadcrumb">
                ...
                @if ($detail->type == 'Undergraduate')
                    <li class="breadcrumb-item"><a href="{{ url('scholarships/undergraduate') }}"
                            class="previewLink">Undergraudate</a></li>
                @elseif ($detail->type == 'Master')
                    <li class="breadcrumb-item"><a href="{{ url('scholarships/master') }}"
                            class="previewLink">Master</a>
                    </li>
                @elseif ($detail->type == 'Phd')
                    <li class="breadcrumb-item"><a href="{{ url('scholarships/phd') }}" class="previewLink">PhD</a>
                    </li>
                @elseif ($detail->type == 'Fellowship')
                    <li class="breadcrumb-item"><a href="{{ url('scholarships/fellowship') }}"
                            class="previewLink">Fellowship</a></li>
                @endif
...
@section('script')
    <script>
        ...
        yes_feedback.addEventListener('click', () => {
            ...
            axios.get('/scholarships/post/like/' + <?php echo $detail->id; ?>)
                .then(res => {
        ...
        create_comment.addEventListener('click', () => {
            if (name.value != "" && comment.value != "") {
                ...
                axios.post('/scholarships/post/comment', formData)
                    .then(function(res) {
