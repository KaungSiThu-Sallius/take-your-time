...
@section('title')
<title>Take Your Time - PhD</title>
@endsection
@section('nav_items')
    ...
    <section>
        <div class="preview">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('scholarships/phd')}}" class="previewLink activeLink">PhD</a></li>
            </ul>
        </div>
    </section>
    ...
    <section class="filter_nav">
        <div class="container-fluid">
            <div class="filter_btns_group">
                ...
                <a href="{{url('/scholarships/phd')}}" class="filter_btn_link"><button type="button" class="btn active filter_btn">PhD</button></a>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <a href="{{url("/scholarships/detail/$d->slug/$d->scholarship_id")}}">
                        <div class="card">
                            <img class="card-img-top" src="{{asset("images_database/$d->image")}}" alt="PhD Image">
                            <div class="card-header">PhD</div>
                            <div class="card-body">
