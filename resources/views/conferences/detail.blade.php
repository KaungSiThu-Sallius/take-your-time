            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-md-7">
                    <div class="info">
                        ...
                        <p> <i class="fas fa-signal"></i> <span style="font-weight: 600;">Field :</span>
                            {{ $detail->field }}</p>
                        ...
                        <p><i class="fa fa-user"></i> <span style="font-weight: 600;">Organized by :</span>
                            {{ $detail->organized_by }}<br></p>
