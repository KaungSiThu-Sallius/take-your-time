        ...
        <div class="container">
            <div class="row">
                <div class="offset-md-3 col-md-9 col-12">
                    <form action="{{ route('competition.update', $competition->id) }}" enctype="multipart/form-data"
                        class="card" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="card-header">
                            <h2 class="mb-4">Update Competition <span
                            ...
                            <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="md-form mb-0">
                                            <input type="text" id="organization" name="organization" class="form-control"
                                                required value="{{ $competition->organization_name }}">
                                    ...
                                    <div class="
                                        ...
                                        <div class="md-form mb-0">
                                            <input type="text" id="apply_form_link" name="apply_form_link"
                                                ...
                                                value="{{ $competition->apply_form_link }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group detail_text">
                                            ...
                                            <textarea class="form-control rounded-0" id="detail" rows="3" name="detail"
                                                required>{{ $competition->details }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group other_text">
                                            ...
                                            <textarea class="form-control rounded-0" id="other_information" rows="3"
                                                name="other_information">{{ $competition->other_information }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    <div class="col-12 image">
                                        <h5 class="mb-4">Competition Image</h5>
                                        ...
                                        <img src="{{ asset("upload_images/$competition->image") }}"
                                            alt="competition_image" style="width:200px; border: 1px solid black; "
                                            class="mt-4">
                                    </div>
                                </div>
