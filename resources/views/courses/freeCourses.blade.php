...
@section('title')
<title>Take Your Time - Free Courses</title>
@endsection
@section('nav_items')
...
<section>
    <div class="preview">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('/courses/freeCourses')}}" class="previewLink activeLink">Free Courses</a></li>
        </ul>
    </div>
</section>
        ...
        <div class="container-fluid">
            <div class="filter_btns_group">
                <a href="{{url('/courses')}}" class="filter_btn_link"><button type="button"
                        class="btn">All
                        Courses</button></a>
                <a href="{{url('/courses/freeCourses')}}" class="filter_btn_link"><button type="button" class="btn active filter_btn">Free
                        Courses</button></a>
                <a href="{{url('/courses/paidCourses')}}" class="filter_btn_link"><button type="button" class="btn">Paid
                        Courses</button></a>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <a href="{{url("/courses/detail/$d->slug/$d->id")}}">
                        <div class="card mb-5">
                            <img class="card-img" src="{{asset("post_images/$d->image")}}" alt="Course Image">
                            ...
                            <div class="courses_footer">
                                ...
                                <span class="course_info">Free Courses</span>
                            </div>
                        </div>
                    </a>
                </div>
